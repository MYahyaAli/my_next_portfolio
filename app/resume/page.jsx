...
const about = {
  ...
  info: [
    {
      feildName: "Name",
      feildValue: "Mohammad Yahya",
    },
    {
      feildName: "Phone",
      feildValue: "+94 77 597 1677",
    },
    {
    ...
    },
    {
      ...
      feildValue: "Sri Lankan",
    },
    {
      feildName: "Email",
      feildValue: "myahya2919@gmail.com",
    },
    {
      feildName: "Freelance",
    ...
    {
      feildName: "Languages",
      feildValue: "English, Sinhala, Tamil",
    },
  ],
};
...
const education = {
  ...
  items: [
    {
      institution: "APIIT (Colombo)",
      position: "Bachelor of Science Computer Science",
      duration: "2020 - 2023",
    },
    {
      institution: "APIIT (Colombo)",
      position: "General Foundation",
      duration: "2019 - 2020",
    },
    {
      institution: "ESoft Metro Campus (Kandy)",
      position: "Diploma in IT(International)",
      duration: "2018 - 2019",
    },
    {
      institution: "Ecole Internationale",
      position: "IGCSE Ordinary Level",
      duration: "2004 - 2018",
    },
  ],
};
                  ...
                  <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px] ">
                    {experience.items.map((item, index) => {
                      return (
                        ...
                        <li
                          key={index}
                          className="bg-[#232329] h-[184px] py-4 px-8 rounded-xl flex flex-col 
